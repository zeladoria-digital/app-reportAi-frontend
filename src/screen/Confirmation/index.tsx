    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (networkState.isConnected && networkState.isInternetReachable) {
                ...
                if (salvoComSucesso) {
                    Alert.alert("Sem conexão de rede", "Sua denúncia foi salva no celular de forma segura. Enviaremos automaticamente quando a internet voltar!");
                }
                else {
    ...
    return (<>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.reviewCard}>
          ...
          {report.fotoUri ? (<Image source={{ uri: report.fotoUri }} style={{ height: 200, borderRadius: 12, marginTop: 12 }}/>) : (<View style={styles.photoPreview}/>)}
        </View>
