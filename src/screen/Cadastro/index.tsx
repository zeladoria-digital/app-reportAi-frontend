...
export function Cadastro() {
    ...
    const validarFormulario = () => {
        ...
        if (!dataNascimento.trim())
            ...
            novosErros.dataNascimento = 'Data inválida ou menor de 18 anos';
        if (!cep.trim())
        ...
        if (!senha.trim())
            ...
            novosErros.senha = 'Senha deve ter ao menos uma letra maiúscula';
        else if (!/[0-9]/.test(senha))
            novosErros.senha = 'Senha deve ter ao menos um número';
          ...
          <View style={styles.cardBranco}>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.inputContainer, erros.nome ? styles.inputError : null]}>
                ...
                <TextInput style={styles.input} placeholder="Seu nome completo" value={nome} onChangeText={(text) => { setNome(text); limparErro('nome'); }}/>
              </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.inputContainer, erros.cpf ? styles.inputError : null]}>
                ...
                <TextInput style={styles.input} placeholder="000.000.000-00" value={cpf} onChangeText={(text) => { setCpf(formatCpf(text)); limparErro('cpf'); }} keyboardType="numeric" maxLength={14}/>
              </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput style={styles.input} placeholder="(84) 99999-9999" value={telefone} onChangeText={(text) => setTelefone(formatTelefone(text))} keyboardType="numeric" maxLength={15}/>
              </View>
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.inputContainer, erros.dataNascimento ? styles.inputError : null]}>
                ...
                <TextInput style={styles.input} placeholder="DD/MM/AAAA" value={dataNascimento} onChangeText={(text) => { setDataNascimento(formatData(text)); limparErro('dataNascimento'); }} keyboardType="numeric" maxLength={10}/>
              </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.inputContainer, erros.cep ? styles.inputError : null]}>
                ...
                <TextInput style={styles.input} placeholder="00000-000" value={cep} onChangeText={(text) => { setCep(formatCep(text)); limparErro('cep'); }} keyboardType="numeric" maxLength={9}/>
              </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.inputContainer, erros.rua ? styles.inputError : null]}>
                ...
                <TextInput style={styles.input} placeholder="Digite a rua" value={rua} onChangeText={(text) => { setRua(text); limparErro('rua'); }}/>
              </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.inputContainer, erros.bairro ? styles.inputError : null]}>
                ...
                <TextInput style={styles.input} placeholder="Digite o bairro" value={bairro} onChangeText={(text) => { setBairro(text); limparErro('bairro'); }}/>
              </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.inputContainer, erros.numeroEndereco ? styles.inputError : null]}>
                ...
                <TextInput style={styles.input} placeholder="Ex: 123 ou SN" value={numeroEndereco} onChangeText={(text) => { setNumeroEndereco(text); limparErro('numeroEndereco'); }}/>
              </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.inputContainer, erros.senha ? styles.inputError : null]}>
                ...
                <TextInput style={styles.input} placeholder="Crie uma senha forte" value={senha} onChangeText={(text) => { setSenha(text); limparErro('senha'); }} secureTextEntry/>
              </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={[styles.inputContainer, erros.confirmarSenha ? styles.inputError : null]}>
                <Ionicons name="lock-closed-outline" size={20} color="gray"/>
                <TextInput style={styles.input} placeholder="Confirme sua senha" value={confirmarSenha} onChangeText={(text) => { setConfirmarSenha(text); limparErro('confirmarSenha'); }} secureTextEntry/>
              </View>
            ...
            <View style={styles.inputGroup}>
              <Pressable style={styles.checkboxContainer} onPress={() => { setAceitouTermos(!aceitouTermos); limparErro('termos'); }}>
                <Ionicons name={aceitouTermos ? "checkbox" : "square-outline"} size={30} color={erros.termos ? '#EF4444' : 'gray'}/>
